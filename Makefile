...
run: ## run all dependencies
	@docker ${docker_args} container rm -f go-blog-cache-write
	@docker ${docker_args} container rm -f go-blog-cache-read-1
	@docker ${docker_args} container rm -f go-blog-cache-read-2
